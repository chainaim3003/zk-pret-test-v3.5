...
let dict = {};
//parse the swagger
export async function parseAndDereference(filePath) {
...
//extract pattern
export function extractPattern(obj) {
    const patternObj = { type: obj.type };
    if (obj.pattern) {
...
export function extractRequiredKeys(obj) {
    const result = {};
    if (obj.required) {
...
export async function generateCircuitsFromPatterns(patterns, filePath) {
...
parseSwagger();
//# sourceMappingURL=parseExpected.js.map