 ...
 */
export function printEXIMResponse(response, companyIdentifier) {
    console.log(`\n🚢 ===== EXIM API RESPONSE =====`);
 ...
 */
export async function fetchEXIMDataWithFullLogging(companyName) {
 ...
 */
export function extractEXIMSummary(response) {
 ...
 */
export function analyzeEXIMCompliance(response) {
 ...
 */
export function isCompanyEXIMCompliant(companyDataOrName) {
