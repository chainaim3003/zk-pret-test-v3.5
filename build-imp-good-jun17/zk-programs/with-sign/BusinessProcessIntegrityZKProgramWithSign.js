...
import { Field, Signature, Struct, ZkProgram, CircuitString, UInt8, Bool, Bytes, Provable, Poseidon } from 'o1js';
...
export const BusinessProcessIntegrityZKProgram = ZkProgram({
    ...
    methods: {
        proveComplianceSCF: {
            ...
            async method(businessProcessIntegrityToProve, businessProcessIntegrityData, oracleSignature) {
...
//# sourceMappingURL=BusinessProcessIntegrityZKProgramWithSign.js.map