 ...
 */
function testRiskMetricsHash(): boolean {
    console.log('🧪 Testing risk metrics hash calculation...');
    
    try {
        // Test the ZK-compliant risk metrics hash
        const hash1 = Poseidon.hash([
            Field(0),     // newInvoiceAmount
            Field(1),     // newInvoiceEvaluationMonth
            Field(100),   // liquidityThreshold
 ...
 */
function testFieldBounds(): boolean {
