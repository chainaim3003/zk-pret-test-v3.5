...
proveComplianceHcAg1ECLNTL: { // Generates the public output
   privateInputs: [
      BusinessProcessIntegrityData,
      Signature,
      //Signature,
   ...
   async method(
      ...
      //creatorPublicKey: PublicKey
         ...
         console.log('actual | content |*******|', actualContent.length() , "BP Type ", businessProcessType.length() );
            ...
            const out = verifyProcessHcAg1ECLNTL( actualContent.values.map((c) => UInt8.from(c.toField())));
...
proveComplianceHcAg3TLMED: { // Generates the public output
   privateInputs: [
      BusinessProcessIntegrityData,
      Signature,
      //Signature,
   ...
   async method(
      ...
      //creatorPublicKey: PublicKey
         ...
         console.log('actual ||||||||||||||| content |||||||||||||||||', actualContent.length() , "BP Type ", businessProcessType.length() );
            ...
            const out = verifyProcessHcAg3TLMED( actualContent.values.map((c) => UInt8.from(c.toField())));
...
proveComplianceHcAg4USTLM: { // Generates the public output
   privateInputs: [
      BusinessProcessIntegrityData,
      Signature,
      //Signature,
   ...
   async method(
      ...
      //creatorPublicKey: PublicKey
         ...
         console.log('actual ||||||||||||||| content |||||||||||||||||', actualContent.length() , "BP Type ", businessProcessType.length() );
            ...
            const out = verifyProcessHcAg4USTLM( actualContent.values.map((c) => UInt8.from(c.toField())));
