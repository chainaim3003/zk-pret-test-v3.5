...
import { GLEIFEnhancedZKProgram, GLEIFEnhancedComplianceData, GLEIFEnhancedProof } from '../../zk-programs/with-sign/GLEIFEnhancedZKProgramWithSign.js';
...
export async function runComprehensiveGLEIFVerificationTest(companyName: string, typeOfNet: string = 'LOCAL') {
