...
import { GLEIFMerkleEnhancedZKProgram } from '../../zk-programs/with-sign/GLEIFMerkleEnhancedZKProgramWithSign.js';
...
import { GLEIFMerkleUtils } from './GLEIFStructuredMerkleTree.js';
/**
...
async function runCompleteMerkleGLEIFVerification(companyName, typeOfNet, testMode) {
    ...
    const enhancedComplianceData = GLEIFCircuitConverter.convertToEnhancedComplianceData(gleifAPIResponse, {
