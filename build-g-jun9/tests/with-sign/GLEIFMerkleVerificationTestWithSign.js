 ...
 */
export async function getGLEIFMerkleVerificationWithSign(companyName, typeOfNet, fieldsToReveal = ['name', 'registration_status', 'lei']) {
 ...
 */
export async function getGLEIFExtendedMerkleVerification(companyName, typeOfNet) {
 ...
 */
export async function getGLEIFBatchMerkleVerification(companyNames, typeOfNet) {
    ...
    try {
        ...
        if (companyNames.length >= 3) {
            ...
            const proof = await GLEIFBatchVerifier.proveBatchCompliance(Field(0), batchTree.root, batchTree.companyWitness(0), batchTree.companyWitness(1), batchTree.companyWitness(2), batchTree.getCompanyTree(0).root, batchTree.getCompanyTree(1).root, batchTree.getCompanyTree(2).root, batchSignature);
 ...
 */
export async function demonstrateGLEIFMerkleCapabilities(companyName, typeOfNet) {
...
//# sourceMappingURL=GLEIFMerkleVerificationTestWithSign.js.map