...
export async function getACTUSRiskSimulationData(userLiquidityThreshold_LCR, url) {
    ...
    const { inflow: cashInflow, outflow: cashOutflow, monthsCount, results: classifiedContracts } = loadAndProcessJsonData(jsondata);
    ...
    const risk1Data = new ACTUSDatao1({
        ...
        // Cash Flow Data
        cashInflows: riskScenario1Data.cashInflow.flat(),
        cashOutflows: riskScenario1Data.cashOutflow.flat(),
...
export async function getRiskBasel3WithSign(userLiquidityThreshold_LCR, url) {
...
//# sourceMappingURL=RiskLiquidityACTUSVerifierTest_basel3_WithsignUtils.js.map