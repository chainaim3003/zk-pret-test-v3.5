 ...
 */
function analyzeEXIMCompliance(apiResponse) {
 ...
 */
function extractEXIMSummary(apiResponse) {
    return {
...
function createComprehensiveEXIMMerkleTree(apiResponse) {
    ...
    function setTreeFieldAsField(fieldName, value, index) {
...
// =================================== Main Test Function ===================================
export async function getEXIMOptimVerification(companyName, typeOfNet) {
    ...
    try {
        ...
        const deployTxn = await Mina.transaction(EXIMdeployerAccount, async () => {
        ...
        const txn = await Mina.transaction(EXIMsenderAccount, async () => {
...
//# sourceMappingURL=EXIMOptimVerificationTestWithSign.js.map