 ...
 */
export async function getGLEIFMerkleVerificationUtils(companyName, typeOfNet, fieldsToReveal = ['name', 'registration_status', 'lei']) {
 ...
 */
export async function compareGLEIFApproaches(companyName, typeOfNet) {
