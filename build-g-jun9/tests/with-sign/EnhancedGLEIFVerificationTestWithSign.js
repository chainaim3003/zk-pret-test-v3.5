...
dotenv.config();
import { Field, Mina, PrivateKey, AccountUpdate, Poseidon, Signature, UInt64 } from 'o1js';
...
import { fetchGLEIFCompanyData, GLEIFCircuitConverter } from './GLEIFUtils.js';
/**
...
async function runEnhancedGLEIFVerification(companyName, typeOfNet, testMode) {
    ...
    const enhancedData = GLEIFCircuitConverter.convertToEnhancedComplianceData(parsedData, {
    ...
    */
    ...
    try {
        ...
        const proof = await GLEIFEnhancedZKProgram.proveCompliance(Field(0), enhancedData, oracleSignature, UInt64.from(Date.now()), Field(70), // complianceThreshold
...
//# sourceMappingURL=EnhancedGLEIFVerificationTestWithSign.js.map