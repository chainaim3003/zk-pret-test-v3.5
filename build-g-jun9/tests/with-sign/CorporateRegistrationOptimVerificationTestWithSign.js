...
dotenv.config();
import { Mina, PrivateKey, AccountUpdate, CircuitString, Signature, MerkleTree, UInt64 } from 'o1js';
 ...
 */
function createComprehensiveCorporateRegistrationMerkleTree(apiResponse, typeOfNet) {
 ...
 */
function createOptimizedComplianceData(extractedData, merkleRoot) {
...
// =================================== Main Test Function ===================================
export async function getCorporateRegistrationOptimVerification(cin, typeOfNet) {
    ...
    try {
        ...
        const deployTxn = await Mina.transaction(MCAdeployerAccount, async () => {
        ...
        const txn = await Mina.transaction(MCAsenderAccount, async () => {
...
//# sourceMappingURL=CorporateRegistrationOptimVerificationTestWithSign.js.map