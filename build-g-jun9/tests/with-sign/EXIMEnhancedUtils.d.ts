 ...
 */
export declare function printEXIMResponse(response: EXIMAPIResponse, companyIdentifier: string, typeOfNet: string): void;
/**
 * Enhanced fetch function with comprehensive response printing
 * Compatible with existing fetchEXIMCompanyData function
 */
export declare function fetchEXIMDataWithFullLogging(companyName: string, typeOfNet: string): Promise<EXIMAPIResponse>;
/**
 * Extract company summary for logging
 */
export declare function extractEXIMSummary(response: EXIMAPIResponse, typeOfNet: string): {
    iec: string;
    entityName: string;
    iecIssueDate: string;
    PAN: string;
 ...
 */
export declare function analyzeEXIMCompliance(response: EXIMAPIResponse, typeOfNet: string): {
    isCompliant: boolean;
 ...
 */
export declare function isCompanyEXIMCompliant(companyDataOrName: EXIMAPIResponse | string, typeOfNet?: string): boolean | Promise<boolean>;
