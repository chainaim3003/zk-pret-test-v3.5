 ...
 */
export declare function fetchGLEIFCompanyDataDetailed(companyName: string, typeOfNet: string): Promise<any>;
/**
 ...
 */
export declare function analyzeGLEIFCompanyData(companyName: string, typeOfNet?: string): Promise<void>;
