 ...
 */
export declare function printCorporateRegistrationResponse(response: CorporateRegistrationAPIResponse, companyIdentifier: string, typeOfNet: string): void;
/**
 ...
 */
export declare function fetchCorporateRegistrationDataWithFullLogging(cin: string, typeOfNet: string): Promise<CorporateRegistrationAPIResponse>;
/**
 * Extract company summary for logging
 */
export declare function extractCorporateRegistrationSummary(response: CorporateRegistrationAPIResponse, typeOfNet: string): {
    companyName: string;
    cin: string;
    status: string;
 ...
 */
export declare function analyzeCorporateRegistrationCompliance(response: CorporateRegistrationAPIResponse, typeOfNet: string): {
    isCompliant: boolean;
 ...
 */
export declare function isCompanyCorporateRegistrationCompliant(companyDataOrCin: CorporateRegistrationAPIResponse | string, typeOfNet?: string): boolean | Promise<boolean>;
