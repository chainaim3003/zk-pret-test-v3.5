...
function createComprehensiveGLEIFMerkleTree(apiResponse) {
    ...
    try {
        ...
        setTreeField('conformity_flag', record.attributes.conformityFlag || registration.conformityFlag, GLEIF_FIELD_INDICES.conformity_flag);
        // Temporal fields
...
// =================================== Main Test Function ===================================
export async function getGLEIFOptimVerificationWithSignUtils(companyName, typeOfNet) {
    ...
    try {
        ...
        const txn = await Mina.transaction(GLEIFsenderAccount, async () => {
...
//# sourceMappingURL=GLEIFOptimVerificationTestWithSignUtils.js.map