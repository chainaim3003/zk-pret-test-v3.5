...
async function main() {
    ...
    console.log('Company Identification Number:', cin);
    let proof = await getCorporateRegistrationVerificationTestWithSign(cin, typeOfNet);
}
main().catch(err => {
    console.error('Error:', err);
});
//# sourceMappingURL=CorporateRegistrationVerificationTestWithSign.js.map