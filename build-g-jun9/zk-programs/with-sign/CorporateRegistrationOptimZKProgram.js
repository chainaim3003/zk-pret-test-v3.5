...
function isCompanyStatusActive(status) {
...
function isDateOfIncorporationValidCheck(dateStr, currentTimestamp) {
...
export const CorporateRegistrationOptim = ZkProgram({
    ...
    methods: {
        proveOptimizedCompliance: {
            ...
            async method(currentTimestamp, complianceData, oracleSignature, companyNameWitness, cinWitness, registrationNumberWitness, companyStatusWitness, dateOfIncorporationWitness, categoryWitness, classOfCompanyWitness, numberOfPartnersWitness, listedWitness, suspendedWitness) {
                ...
                const isDateOfIncorporationValid = isDateOfIncorporationValidCheck(complianceData.dateOfIncorporation, currentTimestamp);
...
//# sourceMappingURL=CorporateRegistrationOptimZKProgram.js.map