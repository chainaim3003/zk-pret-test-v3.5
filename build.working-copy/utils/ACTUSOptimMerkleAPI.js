 ...
 */
export async function callACTUSAPI(url, contracts, riskFactors = []) {
 ...
 */
export async function loadContractPortfolio(portfolioSource) {
 ...
 */
export function getDefaultContractPortfolio() {
    return [
        {
            "contractType": "PAM",
            "contractID": "pam01",
 ...
 */
export function getBasel3ContractPortfolio() {
 ...
 */
export function getStableCoinContractPortfolio() {
    const originalContracts = getDefaultContractPortfolio();
...
//# sourceMappingURL=ACTUSOptimMerkleAPI.js.map