...
export const BusinessStandardDataIntegrityZKProgram = ZkProgram({
    ...
    methods: {
        proveCompliance: {
            ...
            businessStandardDataIntegrityData, // privateInputs[1]
            externalVerificationResult, // privateInputs[2] - NEW: verification result from outside
            oracleSignature // privateInputs[3] - moved to last position
            ) {
                // =================================== Oracle Signature Verification ===================================
                const complianceDataHash = Poseidon.hash(BusinessStandardDataIntegrityComplianceData.toFields(businessStandardDataIntegrityData));
...
//# sourceMappingURL=BusinessStandardDataIntegrityZKProgram.js.map