import { Field, Signature, Struct, ZkProgram, CircuitString, Poseidon, Provable, Bool, UInt8, } from 'o1js';
...
export class BusinessStdIntegrityOptimMerklePublicOutput extends Struct({
    ...
    patternValidationsPassed: Field,
    enumValidationsPassed: Field,
    booleanValidationsPassed: Field,
    arrayValidationsPassed: Field,
    stringValidationsPassed: Field,
...
export const BusinessStdIntegrityOptimMerkleVerifier = ZkProgram({
    ...
    methods: {
        ...
        proveCoreCompliance: {
            ...
            async method(blToProve, datasetRoot, 
            // Pattern validation witnesses
            transportDocRefWitness, shipperNameWitness, issuingNameWitness, addressCityWitness, countryCodeWitness, carrierCodeWitness, 
            // Enum validation witnesses
            docTypeWitness, receiptTypeWitness, deliveryTypeWitness, carrierProviderWitness, 
            // Boolean validation witnesses
            shippedOnBoardWitness, isElectronicWitness, isToOrderWitness, 
            // Array count validation witnesses
            contactsCountWitness, consignmentCountWitness, equipmentCountWitness, voyagesCountWitness, 
            // String existence validation witnesses
            docStatusWitness, streetWitness, termsWitness, cargoOriginWitness, cargoDestWitness, arrivalDateWitness, departureDateWitness, 
            // Pattern validation values
            transportDocumentReference, shipperPartyName, issuingPartyName, addressCity, countryCode, carrierCode, 
            // Enum validation values
            transportDocumentTypeCode, receiptTypeAtOrigin, deliveryTypeAtDestination, carrierCodeListProvider, 
            // Boolean validation values
            isShippedOnBoardType, isElectronic, isToOrder, 
            // Array count validation values
            partyContactDetailsCount, consignmentItemsCount, utilizedTransportEquipmentsCount, vesselVoyagesCount, 
            // String existence validation values
            transportDocumentStatus, street, termsAndConditions, cargoMovementTypeAtOrigin, cargoMovementTypeAtDestination, plannedArrivalDate, plannedDepartureDate, oracleSignature) {
        ...
        proveEnhancedCompliance: {
            ...
            // Core witnesses (24)
            transportDocRefWitness, shipperNameWitness, issuingNameWitness, addressCityWitness, countryCodeWitness, carrierCodeWitness, docTypeWitness, receiptTypeWitness, deliveryTypeWitness, carrierProviderWitness, shippedOnBoardWitness, isElectronicWitness, isToOrderWitness, contactsCountWitness, consignmentCountWitness, equipmentCountWitness, voyagesCountWitness, docStatusWitness, streetWitness, termsWitness, cargoOriginWitness, cargoDestWitness, arrivalDateWitness, departureDateWitness, 
            // Enhanced witnesses (14)
            vesselNameWitness, voyageNumberWitness, equipmentRefWitness, bookingRefWitness, serviceRefWitness, sealNumberWitness, currencyCodeWitness, loadingCountryWitness, dischargeCountryWitness, isoEquipCodeWitness, packageCodeWitness, paymentTermWitness, freightTermWitness, loadingCodeWitness, 
            // All values (24 core + 14 enhanced = 38 total)
            // Core values (24)
            transportDocumentReference, shipperPartyName, issuingPartyName, addressCity, countryCode, carrierCode, transportDocumentTypeCode, receiptTypeAtOrigin, deliveryTypeAtDestination, carrierCodeListProvider, isShippedOnBoardType, isElectronic, isToOrder, partyContactDetailsCount, consignmentItemsCount, utilizedTransportEquipmentsCount, vesselVoyagesCount, transportDocumentStatus, street, termsAndConditions, cargoMovementTypeAtOrigin, cargoMovementTypeAtDestination, plannedArrivalDate, plannedDepartureDate, 
            // Enhanced values (14)
            vesselName, carrierExportVoyageNumber, equipmentReference, carrierBookingReference, serviceContractReference, sealNumber, currencyCode, portOfLoadingCountry, portOfDischargeCountry, ISOEquipmentCode, packageCode, paymentTermCode, freightPaymentTermCode, portOfLoadingCode, oracleSignature) {
                ...
                return new BusinessStdIntegrityOptimMerklePublicOutput({
                    ...
                    isBLCompliant,
                    datasetRoot,
                    fieldsValidated: Field(38),
                    patternValidationsPassed: Field(6),
...
//# sourceMappingURL=BusinessStdIntegrityOptimMerkleZKProgramWithSign.js.map