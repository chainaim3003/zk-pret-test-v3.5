...
declare const ACTUSDatao1_base: (new (value: {
...
export declare class ACTUSDatao1 extends ACTUSDatao1_base {
    constructor(data: {
        scenarioID: CircuitString;
        scenarioName: CircuitString;
        scenarioName_str: string;
...
export declare const LiquidityRatioZkprogram: {
    ...
    privateInputTypes: {
        proveCompliance: [typeof ACTUSDatao1, typeof Signature];
    };
    rawMethods: {
        proveCompliance: (publicInput: import("o1js/dist/node/lib/provable/field.js").Field, ...args: [ACTUSDatao1, Signature] & any[]) => Promise<liquidityratioDataPublicOutput>;
    };
} & {
    proveCompliance: (publicInput: import("o1js/dist/node/lib/provable/field.js").Field, ...args: [ACTUSDatao1, Signature] & any[]) => Promise<Proof<import("o1js/dist/node/lib/provable/field.js").Field, liquidityratioDataPublicOutput>>;
};
