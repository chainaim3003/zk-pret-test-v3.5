import { Field, Signature, Struct, ZkProgram, CircuitString, Poseidon, MerkleWitness, UInt64, Bool, } from 'o1js';
...
function isIECStatusValid(status) {
...
function isDataAsOnCurrentOrPast(dataAsOn, currentTimestamp) {
...
export const EXIMOptim = ZkProgram({
    ...
    methods: {
        proveOptimizedCompliance: {
            ...
            async method(currentTimestamp, complianceData, oracleSignature, iecWitness, entityNameWitness, iecIssueDateWitness, panWitness, iecStatusWitness, iecModificationDateWitness, dataAsOnWitness) {
...
//# sourceMappingURL=EXIMOptimZKProgram.js.map