import { Field, Signature, Struct, ZkProgram, CircuitString, Poseidon, } from 'o1js';
...
export const EXIM = ZkProgram({
    ...
    methods: {
        proveCompliance: {
            privateInputs: [EXIMComplianceDataO1, Signature],
            async method(EXIMToProve, EXIMDatao1, oracleSignature // Oracle Signature
            ) {
...
//# sourceMappingURL=EXIMZKProgramWithSign.js.map