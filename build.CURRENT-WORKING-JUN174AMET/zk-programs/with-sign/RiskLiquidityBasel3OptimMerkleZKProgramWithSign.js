 ...
 * ====================================================================
 */
import { Field, Signature, Struct, ZkProgram, CircuitString, UInt64, Bool, MerkleWitness, } from 'o1js';
...
export class RiskLiquidityBasel3OptimMerkleComplianceData extends Struct({
    ...
    hqlaLevel1Total: Field,
    hqlaLevel2ATotal: Field,
    hqlaLevel2BTotal: Field,
    netCashOutflowsTotal: Field,
    // Basel3 NSFR components (encoded as aggregated values)
    availableStableFundingTotal: Field,
    requiredStableFundingTotal: Field,
...
export const RiskLiquidityBasel3OptimMerkleZKProgramWithSign = ZkProgram({
    ...
    methods: {
        proveBasel3RiskCompliance: {
            ...
            async method(currentTimestamp, complianceData, oracleSignature, companyInfoWitness, cashFlowsWitness, hqlaWitness, nsfrWitness, thresholdsWitness) {
                ...
                return new RiskLiquidityBasel3OptimMerklePublicOutput({
                    ...
                    basel3Compliant: complianceData.basel3Compliant,
                    lcrRatio: complianceData.lcrRatio,
                    nsfrRatio: complianceData.nsfrRatio,
 ...
 */
export function createBasel3RiskComplianceData(scenarioID, scenarioName, hqlaComponents, nsfrComponents, thresholds, additionalParams, merkleRoot, calculatedMetrics) {
 ...
 */
export function calculateBasel3Ratios(hqlaComponents, nsfrComponents, thresholds) {
 ...
 */
export function validateBasel3RiskComplianceData(complianceData) {
...
//# sourceMappingURL=RiskLiquidityBasel3OptimMerkleZKProgramWithSign.js.map