...
import { BusinessStdMerkleUtils } from './BusinessStdIntegrityOptimMerkleUtils.js';
...
export class BusinessStdIntegrityOptimMerkleTestUtils {
     ...
     */
    static createOracleSignature(merkleRoot) {
     ...
     */
    static async createBLMerkleTree(blData) {
     ...
     */
    static validateCriticalFields(values, fieldNames, requiredCount = 24) {
     ...
     */
    static async generateCoreComplianceProof(blData) {
        ...
        try {
            ...
            const proof = await BusinessStdIntegrityOptimMerkleVerifier.proveCoreCompliance(Field(1), // blToProve
            merkleRoot, // datasetRoot
            // Pattern validation witnesses (6 fields: fun0/fun1/fun2)
            patternWitnesses[0], patternWitnesses[1], patternWitnesses[2], patternWitnesses[3], patternWitnesses[4], patternWitnesses[5], 
            ...
            stringWitnesses[0], stringWitnesses[1], stringWitnesses[2], stringWitnesses[3], stringWitnesses[4], stringWitnesses[5], stringWitnesses[6], 
            // Pattern validation values (6 fields)
            patternValues[0], patternValues[1], patternValues[2], patternValues[3], patternValues[4], patternValues[5], 
            ...
            stringValues[0], stringValues[1], stringValues[2], stringValues[3], stringValues[4], stringValues[5], stringValues[6], oracleSignature);
            ...
            console.log(`   Error: ${zkError.message}`);
            console.log('');
     ...
     */
    static async generateEnhancedComplianceProof(blData) {
        ...
        const enhancedOutput = new BusinessStdIntegrityOptimMerklePublicOutput({
            ...
            fieldsValidated: Field(24 + availableAdditionalFields),
     ...
     */
    static async deployContract(zkApp, zkAppPrivateKey, deployerKey) {
     ...
     */
    static async testCoreCompliance(zkApp, proof, senderKey) {
     ...
     */
    static async testEnhancedCompliance(zkApp, proof, senderKey) {
     ...
     */
    static async runComprehensiveTest(blData) {
...
BusinessStdIntegrityOptimMerkleTestUtils.proofsEnabled = true;
//# sourceMappingURL=BusinessStdIntegrityOptimMerkleVerificationTestWithSignUtils.js.map