...
export declare function fetchGLEIFCompanyData(companyName: string): Promise<GLEIFAPIResponse>;
/**
 ...
 */
export declare function isCompanyGLEIFCompliant(companyDataOrName: GLEIFAPIResponse | string): boolean | Promise<boolean>;
/**
 * Fetch full GLEIF structure with detailed analysis
 */
export declare function fetchGLEIFFullStructure(companyName: string): Promise<{
