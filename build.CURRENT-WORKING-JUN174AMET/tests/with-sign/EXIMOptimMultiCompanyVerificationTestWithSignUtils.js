...
import { EXIMOptim, EXIMOptimComplianceData, EXIMMerkleWitness8, EXIM_MERKLE_TREE_HEIGHT, EXIM_FIELD_INDICES } from '../../zk-programs/with-sign/EXIMOptimZKProgram.js';
import { EXIMOptimMultiCompanySmartContract, EXIMCompanyRecord, CompanyMerkleWitness, COMPANY_MERKLE_HEIGHT } from '../../contracts/with-sign/EXIMOptimMultiCompanySmartContract.js';
import { EXIMdeployerAccount, EXIMsenderAccount, EXIMdeployerKey, EXIMsenderKey, getPrivateKeyFor } from '../../core/OracleRegistry.js';
import { fetchEXIMDataWithFullLogging, analyzeEXIMCompliance } from './EXIMEnhancedUtils.js';
...
class CompanyRegistry {
     ...
     */
    addOrUpdateCompany(iec, companyRecord) {
        let index;
 ...
 */
function createComprehensiveEXIMMerkleTree(apiResponse) {
    ...
    function setTreeFieldAsNumber(fieldName, value, index) {
 ...
 */
function createOptimizedEXIMComplianceData(extractedData, merkleRoot) {
...
export async function getEXIMOptimMultiCompanyVerificationWithSignUtils(companyNames) {
    ...
    try {
        ...
        for (let i = 0; i < companyNames.length; i++) {
            ...
            try {
                ...
                const proof = await EXIMOptim.proveOptimizedCompliance(currentTimestamp, complianceData, oracleSignature, iecWitness, entityNameWitness, iecIssueDateWitness, panWitness, iecStatusWitness, iecModificationDateWitness, dataAsOnWitness);
...
//# sourceMappingURL=EXIMOptimMultiCompanyVerificationTestWithSignUtils.js.map