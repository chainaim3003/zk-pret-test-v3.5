...
export async function fetchGLEIFCompanyData(companyName) {
    try {
 ...
 */
export function isCompanyGLEIFCompliant(companyDataOrName) {
 ...
 */
export async function fetchGLEIFFullStructure(companyName) {
