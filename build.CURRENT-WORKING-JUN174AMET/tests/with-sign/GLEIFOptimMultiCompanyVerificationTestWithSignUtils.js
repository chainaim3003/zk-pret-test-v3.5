...
import { GLEIFOptimMultiCompanySmartContract, GLEIFCompanyRecord, CompanyMerkleWitness, COMPANY_MERKLE_HEIGHT } from '../../contracts/with-sign/GLEIFOptimMultiCompanySmartContract.js';
...
import { fetchGLEIFDataWithFullLogging, analyzeGLEIFCompliance } from './GLEIFEnhancedUtils.js';
 ...
 */
function createComprehensiveGLEIFMerkleTree(apiResponse) {
 ...
 */
function createOptimizedGLEIFComplianceData(extractedData, merkleRoot) {
...
export async function getGLEIFOptimMultiCompanyVerificationWithSignUtils(companyNames) {
    ...
    try {
        ...
        for (let i = 0; i < companyNames.length; i++) {
            ...
            try {
                ...
                const proof = await GLEIFOptim.proveOptimizedCompliance(currentTimestamp, complianceData, oracleSignature, entityStatusWitness, registrationStatusWitness, conformityFlagWitness, lastUpdateWitness, nextRenewalWitness, leiWitness, bicWitness, micWitness);
...
//# sourceMappingURL=GLEIFOptimMultiCompanyVerificationTestWithSignUtils.js.map