 ...
 * ====================================================================
 */
import { Field, Signature, Struct, ZkProgram, CircuitString, UInt64, Bool, MerkleWitness, Poseidon, } from 'o1js';
...
export class RiskLiquidityAdvancedOptimMerkleComplianceData extends Struct({
    ...
    cashInflowsHash: Field,
    cashOutflowsHash: Field,
    periodsCount: Field,
...
export const RiskLiquidityAdvancedOptimMerkleZKProgramWithSign = ZkProgram({
    ...
    methods: {
        proveAdvancedRiskCompliance: {
            ...
            async method(currentTimestamp, complianceData, oracleSignature, companyInfoWitness, inflowWitness, outflowWitness, riskMetricsWitness) {
 ...
 */
export function encodeArrayToField(numbers) {
 ...
 */
export function createAdvancedRiskComplianceData(scenarioID, scenarioName, cashInflows, cashOutflows, newInvoiceAmount, newInvoiceEvaluationMonth, liquidityThreshold, merkleRoot, liquidityMetrics) {
 ...
 */
export function validateAdvancedRiskComplianceData(complianceData) {
...
//# sourceMappingURL=RiskLiquidityAdvancedOptimMerkleZKProgramWithSign.js.map