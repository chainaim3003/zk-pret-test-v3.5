 ...
 */
export async function getGLEIFMerkleVerificationWithSign(companyName, fieldsToReveal = ['name', 'registration_status', 'lei']) {
 ...
 */
export async function getGLEIFExtendedMerkleVerification(companyName) {
    ...
    try {
        ...
        console.log(`🔗 LEI: ${proof.publicOutput.lei.toString()}`);
        console.log(`🌍 Country: ${proof.publicOutput.legalAddress_country ? proof.publicOutput.legalAddress_country.toString() : 'N/A'}`);
        console.log(`🏙️ City: ${proof.publicOutput.legalAddress_city ? proof.publicOutput.legalAddress_city.toString() : 'N/A'}`);
        console.log(`⚖️ Jurisdiction: ${proof.publicOutput.jurisdiction ? proof.publicOutput.jurisdiction.toString() : 'N/A'}`);
 ...
 */
export async function demonstrateComprehensiveGLEIFMerkleBundling(companyName) {
