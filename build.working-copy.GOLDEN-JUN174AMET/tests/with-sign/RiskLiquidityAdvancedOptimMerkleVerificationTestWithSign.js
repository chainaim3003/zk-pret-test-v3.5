...
import { fetchRiskLiquidityAdvancedOptimMerkleData, processAdvancedRiskData, buildAdvancedRiskMerkleStructure, calculateAdvancedRiskMetrics, validateAdvancedRiskData, generateAdvancedRiskSummary, loadAdvancedMasterConfiguration, loadExecutionSettings, applyDynamicThresholdStrategy, validateFieldArithmeticConstraints } from '../../utils/RiskLiquidityAdvancedOptimMerkleUtils.js';
import { RiskLiquidityAdvancedOptimMerkleZKProgramWithSign, createAdvancedRiskComplianceData, validateAdvancedRiskComplianceData } from '../../zk-programs/with-sign/RiskLiquidityAdvancedOptimMerkleZKProgramWithSign.js';
...
export async function executeRiskLiquidityAdvancedOptimMerkleVerification(liquidityThreshold, actusUrl = 'http://localhost:8083/eventsBatch', contractPortfolio, executionMode = 'production') {
    ...
    try {
        ...
        const advancedRiskData = processAdvancedRiskData(actusResponse, dynamicThresholds.baseThreshold, 5000, // newInvoiceAmount
        Math.min(11, actusResponse.periodsCount || 1), // newInvoiceEvaluationMonth - ensure it's within range
        masterConfig, executionMode);
        ...
        const zkComplianceData = createAdvancedRiskComplianceData(advancedRiskData.companyID, advancedRiskData.companyName, advancedRiskData.cashInflow, advancedRiskData.cashOutflow, advancedRiskData.newInvoiceAmount, advancedRiskData.newInvoiceEvaluationMonth, advancedRiskData.liquidityThreshold, merkleRoot, {
        ...
        const proof = await RiskLiquidityAdvancedOptimMerkleZKProgramWithSign.proveAdvancedRiskCompliance(currentTimestamp, zkComplianceData, oracleSignature, merkleStructure.witnesses.companyInfo, merkleStructure.witnesses.cashInflow, merkleStructure.witnesses.cashOutflow, merkleStructure.witnesses.riskMetrics);
...
async function main() {
    ...
    const result = await executeRiskLiquidityAdvancedOptimMerkleVerification(liquidityThreshold, actusUrl, portfolioPath, executionMode);
    if (result.success) {
...
//# sourceMappingURL=RiskLiquidityAdvancedOptimMerkleVerificationTestWithSign.js.map