...
// Validation function
export function isValidGLEIFFieldIndex(index) {
    return Object.values(GLEIF_FIELD_INDICES).includes(index);
}
// Helper function to get field name by index
export function getGLEIFFieldName(index) {
    const entry = Object.entries(GLEIF_FIELD_INDICES).find(([_, value]) => value === index);
    return entry ? entry[0] : undefined;
}
// Export default for easy import
export default GLEIF_FIELD_INDICES;
//# sourceMappingURL=GLEIFFieldIndices.js.map