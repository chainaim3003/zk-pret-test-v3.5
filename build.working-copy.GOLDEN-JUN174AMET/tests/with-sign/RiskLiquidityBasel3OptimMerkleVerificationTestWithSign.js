...
import { fetchRiskLiquidityBasel3OptimMerkleData, processBasel3RiskDataOptimMerkle, buildBasel3RiskMerkleStructure, calculateBasel3RiskMetricsOptimMerkle, validateBasel3RiskDataOptimMerkle, generateBasel3RiskSummaryOptimMerkle } from '../../utils/RiskLiquidityBasel3OptimMerkleUtils.js';
import { RiskLiquidityBasel3OptimMerkleZKProgramWithSign, createBasel3RiskComplianceData, validateBasel3RiskComplianceData } from '../../zk-programs/with-sign/RiskLiquidityBasel3OptimMerkleZKProgramWithSign.js';
...
export async function executeRiskLiquidityBasel3OptimMerkleVerification(lcrThreshold, nsfrThreshold = 100, actusUrl = 'http://localhost:8083/eventsBatch', contractPortfolio) {
    ...
    try {
        ...
        const basel3RiskData = await processBasel3RiskDataOptimMerkle(actusResponse, lcrThreshold, nsfrThreshold, 10, // liquidityThreshold
        ...
        const calculatedMetrics = {
            lcrRatio: riskMetrics.totalBasedLCR,
            nsfrRatio: riskMetrics.totalBasedNSFR,
        ...
        const tempZkComplianceData = createBasel3RiskComplianceData(basel3RiskData.companyID, basel3RiskData.companyName, hqlaComponents, nsfrComponents, thresholds, additionalParams, Field(0), // ← PLACEHOLDER ROOT - will be replaced with dynamic root
        calculatedMetrics);
        ...
        const zkComplianceData = createBasel3RiskComplianceData(basel3RiskData.companyID, basel3RiskData.companyName, hqlaComponents, nsfrComponents, thresholds, additionalParams, dynamicMerkleRoot, // ← USE DYNAMIC ROOT calculated after data processing
        calculatedMetrics);
        ...
        try {
            const proof = await RiskLiquidityBasel3OptimMerkleZKProgramWithSign.proveBasel3RiskCompliance(currentTimestamp, zkComplianceData, oracleSignature, merkleStructure.witnesses.companyInfo, merkleStructure.witnesses.cashFlows, merkleStructure.witnesses.hqlaComponents, merkleStructure.witnesses.nsfrComponents, merkleStructure.witnesses.thresholds);
...
async function main() {
    ...
    let contractPortfolio = undefined;
    if (portfolioPath) {
    ...
    const result = await executeRiskLiquidityBasel3OptimMerkleVerification(lcrThreshold, nsfrThreshold, actusUrl, contractPortfolio);
    if (result.success) {
...
//# sourceMappingURL=RiskLiquidityBasel3OptimMerkleVerificationTestWithSign.js.map