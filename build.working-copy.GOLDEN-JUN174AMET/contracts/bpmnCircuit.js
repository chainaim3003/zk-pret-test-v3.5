...
import { Bool, SmartContract, state, State, method, Bytes, Provable } from 'o1js';
...
], bpmnCircuit.prototype, "verifyTraceSCF", null);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Bytes50]),
    __metadata("design:returntype", Promise)
], bpmnCircuit.prototype, "verifyTraceSTABLECOIN", null);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Bytes50]),
    __metadata("design:returntype", Promise)
], bpmnCircuit.prototype, "verifyTraceDVP", null);
// Command used: 'a(cb|bc)d(ef|f)g' '--functionName' 'verifyProcess' '--filePath' './src/bpmnCircuit.ts'
export function verifyProcessSCF(input) {
    Provable.asProver(() => {
...
export function verifyProcessSTABLECOIN(input) {
    Provable.asProver(() => {
...
export function verifyProcessDVP(input) {
    Provable.asProver(() => {
