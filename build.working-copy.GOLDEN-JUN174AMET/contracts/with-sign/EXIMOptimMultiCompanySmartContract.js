...
export class EXIMOptimMultiCompanySmartContract extends SmartContract {
     ...
     */
    getCompanyInfo(companyWitness, companyRecord) {
     ...
     */
    getCurrentCompliance(companyWitness, companyRecord) {
        // Add required state precondition
        this.companiesRootHash.requireEquals(this.companiesRootHash.get());
        // Verify the company record exists in the merkle tree
        const companyRecordHash = Poseidon.hash([
     ...
     */
    getVerificationStats(companyWitness, companyRecord) {
        // Add required state precondition
        this.companiesRootHash.requireEquals(this.companiesRootHash.get());
        // Verify the company record exists in the merkle tree
        const companyRecordHash = Poseidon.hash([
     ...
     */
    isTrackingCompanyByName(companyName, companyWitness, companyRecord) {
        // Add required state precondition
        this.companiesRootHash.requireEquals(this.companiesRootHash.get());
     ...
     */
    isCompanyEXIMCompliant(companyName, companyWitness, companyRecord) {
        // Add required state precondition
        this.companiesRootHash.requireEquals(this.companiesRootHash.get());
     ...
     */
    isTrackingCompany(iecHash, companyWitness, companyRecord) {
        // Add required state precondition
        this.companiesRootHash.requireEquals(this.companiesRootHash.get());
     ...
     */
    async resetComplianceForCompany(companyWitness, companyRecord) {
        // Add required state preconditions
        this.companiesRootHash.requireEquals(this.companiesRootHash.get());
        this.compliantCompaniesCount.requireEquals(this.compliantCompaniesCount.get());
        // Verify the company record exists in the merkle tree
     ...
     */
    getCompanyComplianceByName(companyName, companyWitness, companyRecord) {
...
], EXIMOptimMultiCompanySmartContract.prototype, "companiesRootHash", void 0);
__decorate([
    state(Field),
    __metadata("design:type", Object)
], EXIMOptimMultiCompanySmartContract.prototype, "totalCompaniesTracked", void 0);
__decorate([
    state(Field),
    __metadata("design:type", Object)
], EXIMOptimMultiCompanySmartContract.prototype, "compliantCompaniesCount", void 0);
__decorate([
    state(Field),
    __metadata("design:type", Object)
], EXIMOptimMultiCompanySmartContract.prototype, "globalComplianceScore", void 0);
__decorate([
    state(Field),
    __metadata("design:type", Object)
], EXIMOptimMultiCompanySmartContract.prototype, "totalVerificationsGlobal", void 0);
__decorate([
    state(UInt64),
    __metadata("design:type", Object)
], EXIMOptimMultiCompanySmartContract.prototype, "lastVerificationTime", void 0);
__decorate([
    state(Field),
    __metadata("design:type", Object)
], EXIMOptimMultiCompanySmartContract.prototype, "registryVersion", void 0);
__decorate([
    state(UInt64),
    __metadata("design:type", Object)
], EXIMOptimMultiCompanySmartContract.prototype, "contractCreationTime", void 0);
__decorate([
    method,
...
], EXIMOptimMultiCompanySmartContract.prototype, "verifyOptimizedComplianceWithProof", null);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [CompanyMerkleWitness,
        EXIMCompanyRecord]),
    __metadata("design:returntype", Promise)
], EXIMOptimMultiCompanySmartContract.prototype, "resetComplianceForCompany", null);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], EXIMOptimMultiCompanySmartContract.prototype, "resetRegistry", null);
//# sourceMappingURL=EXIMOptimMultiCompanySmartContract.js.map