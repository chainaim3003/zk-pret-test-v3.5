...
import { CorporateRegistrationOptim, CorporateRegistrationOptimComplianceData, CorporateRegistrationMerkleWitness8, CORP_REG_MERKLE_TREE_HEIGHT, CORP_REG_FIELD_INDICES } from '../../zk-programs/with-sign/CorporateRegistrationOptimZKProgram.js';
import { CorporateRegistrationOptimMultiCompanySmartContract, CorporateRegistrationCompanyRecord, CompanyMerkleWitness, COMPANY_MERKLE_HEIGHT } from '../../contracts/with-sign/CorporateRegistrationOptimMultiCompanySmartContract.js';
import { MCAdeployerAccount, MCAsenderAccount, MCAdeployerKey, MCAsenderKey, getPrivateKeyFor } from '../../core/OracleRegistry.js';
import { fetchCorporateRegistrationDataWithFullLogging, analyzeCorporateRegistrationCompliance } from './CorporateRegistrationEnhancedUtils.js';
...
class CompanyRegistry {
     ...
     */
    addOrUpdateCompany(cin, companyRecord) {
        let index;
 ...
 */
function createComprehensiveCorporateRegistrationMerkleTree(apiResponse) {
    ...
    function setTreeField(fieldName, value, index) {
 ...
 */
function createOptimizedCorporateRegistrationComplianceData(extractedData, merkleRoot) {
 ...
 */
function createCompanyRecord(complianceData, isCompliant, verificationTimestamp, isFirstVerification = true) {
...
export async function getCorporateRegistrationOptimMultiCompanyVerificationWithSignUtils(companyNames) {
    ...
    try {
        ...
        for (let i = 0; i < companyNames.length; i++) {
            ...
            try {
                ...
                const apiResponse = await fetchCorporateRegistrationDataWithFullLogging(companyName);
                ...
                const proof = await CorporateRegistrationOptim.proveOptimizedCompliance(currentTimestamp, complianceData, oracleSignature, companyNameWitness, cinWitness, registrationNumberWitness, companyStatusWitness, dateOfIncorporationWitness, categoryWitness, classOfCompanyWitness, numberOfPartnersWitness, listedWitness, suspendedWitness);
 ...
 */
export async function verifySingleCompanyInMultiContract(companyName, zkApp, companyRegistry) {
...
//# sourceMappingURL=CorporateRegistrationOptimMultiCompanyVerificationTestWithSignUtils.js.map