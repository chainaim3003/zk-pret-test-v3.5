 ...
 */
import { Field, Signature, Struct, ZkProgram, CircuitString, UInt64, Bool, Poseidon, } from 'o1js';
...
export class RiskLiquidityStableCoinOptimMerkleComplianceData extends Struct({
    ...
    regulatoryScore: Field,
    regulatoryThreshold: Field,
        ...
        proveStableCoinRiskCompliance: {
            ...
            async method(currentTimestamp, complianceData, oracleSignature, companyInfoWitness, reservesWitness, tokensWitness, qualityWitness, thresholdsWitness) {
                ...
                return new RiskLiquidityStableCoinOptimMerklePublicOutput({
                    ...
                    regulatoryCompliant: complianceData.regulatoryCompliant,
                    regulatoryScore: complianceData.regulatoryScore,
...
// =================================== Utility Functions ===================================
export function createStableCoinRiskComplianceData(scenarioID, scenarioName, reserveComponents, tokenInfo, qualityMetrics, thresholds, additionalParams, merkleRoot, calculatedMetrics, regulatoryData, currentTimestamp = Date.now() // ✅ FIXED: Pass timestamp as parameter
) {
...
//# sourceMappingURL=RiskLiquidityStableCoinOptimMerkleZKProgramWithSign.js.map