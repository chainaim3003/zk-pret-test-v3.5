import { Field, Signature, Struct, ZkProgram, CircuitString, Poseidon, Bool, UInt64, PublicKey, } from 'o1js';
import { getPublicKeyFor } from '../../core/OracleRegistry.js';
import { MerkleWitness7 } from '../../tests/with-sign/GLEIFStructuredMerkleTree.js';
...
export class GLEIFMerkleComplianceData extends Struct({
    ...
    isEntityActive: Bool,
    isRegistrationIssued: Bool,
    hasValidConformity: Bool,
...
export const GLEIFMerkleEnhancedZKProgram = ZkProgram({
    ...
    methods: {
        ...
        proveSelectiveCompliance: {
            ...
            async method(gleifToProve, gleifData, merkleProofs, oracleSignature, currentTimestamp, complianceThreshold, riskThreshold) {
                // =================================== Oracle Signature Verification ===================================
                const complianceDataHash = Poseidon.hash(GLEIFMerkleComplianceData.toFields(gleifData));
                const registryPublicKey = getPublicKeyFor('GLEIF');
                const isValidSignature = oracleSignature.verify(registryPublicKey, [complianceDataHash]);
...
export class GLEIFMerkleUtils {
     ...
     */
    static createMerkleComplianceDataFromAPI(apiResponse, merkleTree, complianceScore = 85, riskLevel = 2) {
     ...
     */
    static createMerkleProofInputs(merkleTree) {
...
//# sourceMappingURL=GLEIFMerkleEnhancedZKProgramWithSign.js.map