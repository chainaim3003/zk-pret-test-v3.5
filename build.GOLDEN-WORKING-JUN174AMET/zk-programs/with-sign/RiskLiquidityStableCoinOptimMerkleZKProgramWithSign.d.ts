...
declare const RiskLiquidityStableCoinOptimMerkleComplianceData_base: (new (value: {
    ...
    regulatoryJurisdiction: CircuitString;
    regulatoryScore: import("o1js/dist/node/lib/provable/field.js").Field;
    regulatoryThreshold: import("o1js/dist/node/lib/provable/field.js").Field;
    regulatoryCompliant: import("o1js/dist/node/lib/provable/bool.js").Bool;
    ...
    regulatoryScore: bigint;
    regulatoryThreshold: bigint;
    ...
    fromValue: (value: {
        ...
        regulatoryJurisdiction: string | CircuitString | {
            values: import("o1js/dist/node/lib/provable/string.js").Character[];
        };
        regulatoryScore: string | number | bigint | import("o1js/dist/node/lib/provable/field.js").Field;
        regulatoryThreshold: string | number | bigint | import("o1js/dist/node/lib/provable/field.js").Field;
        regulatoryCompliant: boolean | import("o1js/dist/node/lib/provable/bool.js").Bool;
...
export declare function createStableCoinRiskComplianceData(scenarioID: string, scenarioName: string, reserveComponents: {
    ...
    threshold: number;
    compliant: boolean;
}, currentTimestamp?: number): RiskLiquidityStableCoinOptimMerkleComplianceData;
